...
class Icon {
    ...
    public static char2dataURL(char: string, className = "icon"): string {
        return Icon.svg2dataURL(`<svg class="${className}" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><text x="64" y="108" font-size="128" text-anchor="middle">${char}</text></svg>`);
    }
    ...
    public static html2dataURL(
        ...
        return Icon.svg2dataURL(`<svg class="${className}" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${width} ${height}"><style>@media (prefers-color-scheme: light) {*{fill: ${lightColor};}} @media (prefers-color-scheme: dark) {*{fill: ${darkColor};}}</style>${html}</svg>`);
    }
